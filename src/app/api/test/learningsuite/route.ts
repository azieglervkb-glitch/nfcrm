  ...
  try {
    ...
    return NextResponse.json({
      ...
      memberProgress: {
        ...
        currentModuleName: memberProgress.currentModuleName,
        totalProgress: memberProgress.totalProgress,
        unlockedModules: memberProgress.unlockedModules,
        totalModules: memberProgress.totalModules,
        coursesCount: memberProgress.courses.length,
        courses: memberProgress.courses.map((course) => ({
          id: course.id,
          title: course.title,
          progress: course.progress,
          progressShownToMember: course.progressShownToMember,
